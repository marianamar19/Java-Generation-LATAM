...
3. [Cómo levantar el servidor local](#cómo-levantar-el-servidor-local)
4. [Arquitectura de archivos](#arquitectura-de-archivos)
5. [Design System](#design-system)
6. [Patrón de inyección de componentes](#patrón-de-inyección-de-componentes)
...
HERA es una tienda en línea que comercializa perfumes originales (diseñador, nicho, árabes, testers, decants y body mist) y joyería exclusiva. El sitio está construido como un monorepo frontend puro — sin framework — con la siguiente filosofía de diseño:
...
- No se requiere Node.js ni ningún bundler para el desarrollo local.
...
**Procedimiento correcto con Live Server:**

1. Abrir VS Code y seleccionar **File > Open Folder**.
2. Seleccionar la carpeta que **contiene** a `frontend/` — es decir, la carpeta raíz del repositorio, no la carpeta `frontend/` en sí.
3. En el panel de archivos, navegar hasta `frontend/pages/catalogo.html`.
4. Hacer clic derecho sobre el archivo y seleccionar **Open with Live Server**.
5. La URL resultante debe tener la forma `http://127.0.0.1:5500/frontend/pages/catalogo.html`.

Si la URL no incluye `/frontend/` como segmento del path, las rutas de `fetch` no resolverán correctamente y los componentes (navbar, cart drawer, footer) no se inyectarán.
...
El `#navbar-placeholder` **debe estar dentro del `<div class="site-wrap">`** para que `position: sticky` funcione correctamente en el navegador. Los placeholders del cart drawer y del search overlay pueden estar fuera del `site-wrap` porque son `position: fixed`.
...
|---------------------------------|---------------------------------------------------------|------------------------------------------------|
| `pages/index.html`              | `/frontend/pages/index.html`                            | Home — hero, novedades, categorías destacadas  |
| `pages/catalogo.html`           | `/frontend/pages/catalogo.html`                         | Catálogo con filtros, sort y tabs              |
| `pages/producto.html`           | `/frontend/pages/producto.html?id=[id]`                 | Detalle de producto individual                 |
| `pages/nosotros.html`           | `/frontend/pages/nosotros.html`                         | Historia y valores de la marca                 |
| `pages/contacto.html`           | `/frontend/pages/contacto.html`                         | Formulario de contacto                         |
| `pages/favoritos.html`          | `/frontend/pages/favoritos.html`                        | Lista de productos guardados                   |
| `pages/faq.html`                | `/frontend/pages/faq.html`                              | Preguntas frecuentes generales                 |
| `pages/politica-envios.html`    | `/frontend/pages/politica-envios.html`                  | Política de envíos y ciclo semanal             |
| `pages/devoluciones.html`       | `/frontend/pages/devoluciones.html`                     | Política de devoluciones y cambios             |
| `pages/terminos.html`           | `/frontend/pages/terminos.html`                         | Términos y condiciones del servicio            |
| `pages/aviso-privacidad.html`   | `/frontend/pages/aviso-privacidad.html`                 | Aviso de privacidad                            |
| `pages/checkout.html`           | `/frontend/pages/checkout.html`                         | Proceso de pago                                |
| `pages/cuenta.html`             | `/frontend/pages/cuenta.html`                           | Dashboard del usuario autenticado              |
| `pages/rastreo.html`            | `/frontend/pages/rastreo.html`                          | Rastreo del estado de un pedido                |
| `pages/confirmacion.html`       | `/frontend/pages/confirmacion.html`                     | Confirmación de compra exitosa                 |
| `pages/404.html`                | `/frontend/pages/404.html`                              | Página de error para rutas no encontradas      |
...
4. Colocar `#navbar-placeholder` como primer hijo dentro de `.site-wrap`.
